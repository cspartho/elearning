...
from courses.views import (ContentCreateUpdateView, ContentDeleteView,
                           ContentOrderView, CourseListView,
                           CourseModuleUpdateView, ModuleContentListView,
                           ModuleOrderView)

from .views import (CourseCreateView, CourseDeleteView, CourseDetailView,
                    CourseListView, CourseUpdateView, ManageCourseListView)
